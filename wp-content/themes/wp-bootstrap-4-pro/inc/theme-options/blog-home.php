...
wp_bootstrap_5_Kirki::add_section( 'blog_home', array(
    'title'          => esc_html__( 'Blog Homepage', 'wp-bootstrap-5' ),
    'panel'          => 'theme_options',
...
wp_bootstrap_5_Kirki::add_field( 'wp_bootstrap_5_theme', array(
	...
	'section'  => 'blog_home',
	'type'     => 'custom',
    'default'  => '<h2 class="wp-bp-region-title first-region-title">' . esc_html__( 'Cover Section', 'wp-bootstrap-5' ) . '</h2>',
) );

wp_bootstrap_5_Kirki::add_field( 'wp_bootstrap_5_theme', array(
	'settings' => 'blog_display_cover_section',
	'label'    => esc_html__( 'Display Cover Section', 'wp-bootstrap-5' ),
	'section'  => 'blog_home',
	'type'     => 'checkbox',
    'default'  => 1,
) );
...
wp_bootstrap_5_Kirki::add_field( 'wp_bootstrap_5_theme', array(
	...
	'label'             => esc_html__( 'Cover Lead Text', 'wp-bootstrap-5' ),
	'section'           => 'blog_home',
	'type'              => 'text',
) );
...
wp_bootstrap_5_Kirki::add_field( 'wp_bootstrap_5_theme', array(
	...
	'section'  => 'blog_home',
	'type'     => 'custom',
    'default'  => '<h2 class="wp-bp-region-title">' . esc_html__( 'Featured Posts Slider', 'wp-bootstrap-5' ) . '</h2>',
) );

wp_bootstrap_5_Kirki::add_field( 'wp_bootstrap_5_theme', array(
	'settings' => 'blog_display_posts_slider',
	'label'    => esc_html__( 'Display Posts Slider', 'wp-bootstrap-5' ),
	'section'  => 'blog_home',
	'type'     => 'checkbox',
    'default'  => 1,
) );
...
wp_bootstrap_5_Kirki::add_field( 'wp_bootstrap_5_theme', array(
	...
	'label'    => esc_html__( 'Number of Posts In Slider', 'wp-bootstrap-5' ),
	'section'  => 'blog_home',
	'type'     => 'number',
    'default'  => '5',
    'choices'  => array(
...
if( class_exists( 'Kirki_Helper' ) ) {
    wp_bootstrap_5_Kirki::add_field( 'wp_bootstrap_5_theme', array(
    	...
    	'label'       => esc_html__( 'Select Posts', 'wp-bootstrap-5' ),
    	'section'     => 'blog_home',
    	'type'        => 'select',
        'multiple'    => 10,
